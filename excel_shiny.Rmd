...
## [Automatic Calf Feeder Breakeven Price Calculator](https://kotamine.shinyapps.io/AutomaticCalfFeeder/) 

![](img/Calf_feeder.png)


## [Robot vs Parlor Investment Decision Calculator](https://kotamine.shinyapps.io/RobotParlor/)
![](img/robot_parlor.png)  


## [Dairy Visual Benchmark](https://kotamine.shinyapps.io/VisualBenchmark/) 
